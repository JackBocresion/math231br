\usepackage{%
  ...
  nicematrix, % for block matrices
  minitoc     % for chapter-level mini table of contents
}

% Minitoc
\dominitoc
\setcounter{minitocdepth}{1} % sections only
