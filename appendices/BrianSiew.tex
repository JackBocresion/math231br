...
\begin{proof}
    ...
    \begin{enumerate}[i.]
        ...
        $$
        Z_{r+1}^{p,q}/B_{r+1}^{p,q} \to \frac{\ker \left(d_r:E_r^{p,q} \to E_r^{p+r,q-r+1}\right)}{\im\left(d_r:E_r^{p-r,q+r-1} \to E_r^{p,q}\right)}
        $$
        ...
        $$
        Next, we analyze the $dZ$ term in the boundary space. Since $\ell \geq n=p+q$, we must have $p-\ell \leq -q \leq 0$. Therefore, $Z_\ell^{p-\ell,q+\ell-1} = \left\{x\in F^{p-\ell}K^{n-1} =K^{n-1}\mid dx\in F^p K^{n}\right\}$. Applying the differential $d$ gives us exactly $dZ_\ell^{p-\ell,q+\ell-1}=F^pK^n\cap \im (d)$. 
        ...
        &= \frac{\ker \left(d:F^pK^n\to F^pK^{n+1}\right)}{ \ker \left(d:F^{p+1}K^n\to F^{p+1}K^{n+1}\right) +F^pK^n\cap \im (d)} 
        \end{align*}
        ...
        \begin{align*}
        E_{\ell+1}^{p,q} &= \frac{\im \left(H^n\left(F^pK^\bullet\right)\to H^n\left(K^\bullet\right)\right)}{\im \left(H^n\left(F^{p+1}K^\bullet\right)\to H^n\left(K^\bullet\right)\right)} \\
